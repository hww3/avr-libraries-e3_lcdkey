 ...
 */
void E3_LCDKey::e3_set_pixels( uint8_t data[], uint8_t array_bytes, uint16_t line_address)
{
 ...
 */
void E3_LCDKey::e3_set_color( uint8_t red_byte, uint8_t green_byte, uint8_t blue_byte)
{
 ...
 */
void E3_LCDKey::e3_bar_graph( uint8_t bar_value, uint16_t line)
{
...
uint8_t col;
	for(col = 0; col < E3_IMAGE_WIDTH; col++)
	{
 ...
 */
void E3_LCDKey::e3_clear_line( uint16_t line)
{
 ...
 */
void E3_LCDKey::e3_set_scr( uint8_t data_byte)
{
uint16_t row;
	write_byte( E3_SET_ADDR ); 
	write_address(0x0000); 
	for(row = 0; row < E3_IMAGE_BYTES; row++)
	{
 ...
 */
void E3_LCDKey::e3_set_text_line( char* text, uint8_t justify, uint16_t line)
{
...
void E3_LCDKey::e3_set_text_loc( char* text, uint8_t mode_option, uint8_t exact_length_char, uint8_t justify, uint16_t line, uint8_t text_loc)
{
...
void E3_LCDKey::e3_set_image( uint8_t image_index)
{
	write_byte( E3_SET_ADDR ); 
	write_address(0x0000); 
 uint16_t row  ;
 ...
 */
void E3_LCDKey::write_byte( uint8_t data) //
{
 ...
 */
void E3_LCDKey::write_data( uint8_t data) //
{
 ...
 */
void E3_LCDKey::write_address( uint16_t addr_data)
{
